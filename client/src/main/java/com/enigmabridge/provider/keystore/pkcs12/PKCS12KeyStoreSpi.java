package com.enigmabridge.provider.keystore.pkcs12;

import com.enigmabridge.provider.EBJcaJceHelper;
...
{
    private final JcaJceHelper helper = new EBJcaJceHelper();
    ...
    public PKCS12KeyStoreSpi(
        ...
        EnigmaProvider ebProvider)
    {
        this.keyAlgorithm = keyAlgorithm;
        this.certAlgorithm = certAlgorithm;
        this.provider = ebProvider;
    ...
    public void engineSetKeyEntry(
        ...
        throws KeyStoreException
    {
        if (!(key instanceof PrivateKey) && !(key instanceof EBKey))
        {
    ...
    {
        public BCPKCS12KeyStore(EnigmaProvider provider)
        {
            super(new BouncyCastleProvider(), pbeWithSHAAnd3_KeyTripleDES_CBC, pbeWithSHAAnd40BitRC2_CBC, provider);
        }
    }
    ...
    public static class BCPKCS12KeyStore3DES
        extends PKCS12KeyStoreSpi
    {
        public BCPKCS12KeyStore3DES(EnigmaProvider provider)
        {
            super(new BouncyCastleProvider(), pbeWithSHAAnd3_KeyTripleDES_CBC, pbeWithSHAAnd3_KeyTripleDES_CBC, provider);
        }
    }
    ...
    public static class DefPKCS12KeyStore
        extends PKCS12KeyStoreSpi
    {
        public DefPKCS12KeyStore(EnigmaProvider provider)
        {
            super(null, pbeWithSHAAnd3_KeyTripleDES_CBC, pbeWithSHAAnd40BitRC2_CBC, provider);
        }
    }
    ...
    public static class DefPKCS12KeyStore3DES
        extends PKCS12KeyStoreSpi
    {
        public DefPKCS12KeyStore3DES(EnigmaProvider provider)
        {
            super(null, pbeWithSHAAnd3_KeyTripleDES_CBC, pbeWithSHAAnd3_KeyTripleDES_CBC, provider);
        }
    }
