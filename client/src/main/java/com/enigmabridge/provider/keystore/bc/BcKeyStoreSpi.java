package com.enigmabridge.provider.keystore.bc;
    ...
    implements BCKeyStore
{
    ...
    public BcKeyStoreSpi(int version, EnigmaProvider provider)
    {
    ...
    {
        public BouncyCastleStore(EnigmaProvider provider)
        {
            super(1, provider);
        }
    ...
    public static class Std
       extends BcKeyStoreSpi
    {
        public Std(EnigmaProvider provider)
        {
            super(STORE_VERSION, provider);
        }
    }
    ...
    public static class Version1
        extends BcKeyStoreSpi
    {
        public Version1(EnigmaProvider provider)
        {
            super(1, provider);
        }
    }
