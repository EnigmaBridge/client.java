    ...
    extends SignatureSpi
{
        ...
        throws InvalidKeyException
    {
        ...
        pss.init(false,
            RSAUtil.generatePublicKeyParameter((EBRSAPublicKey)publicKey));
    }
        ...
        throws InvalidKeyException
    {
        ...
        pss = new org.bouncycastle.crypto.signers.PSSSigner(signer, contentDigest, mgfDigest, saltLength, trailer);
        pss.init(true, new ParametersWithRandom(RSAUtil.generatePrivateKeyParameter((EBRSAPrivateKey)privateKey), random));
    }
        ...
        throws InvalidKeyException
    {
        ...
        pss = new org.bouncycastle.crypto.signers.PSSSigner(signer, contentDigest, mgfDigest, saltLength, trailer);
        pss.init(true, RSAUtil.generatePrivateKeyParameter((EBRSAPrivateKey)privateKey));
    }
